...
def llenar_hoja1(d):
    ...
    if tipo == "INGRESO":   sw(ws, "A20",  "X")
    if tipo == "PERIÓDICO": sw(ws, "N20",  "X")
    if tipo == "REINTEGRO": sw(ws, "AC20", "X")
    if tipo == "RETIRO":    sw(ws, "AL20", "X")
    ...
    # Estilo de vida — AH45=checkbox, AK45=tiempo, AT45=cuál (fila 45 datos)
